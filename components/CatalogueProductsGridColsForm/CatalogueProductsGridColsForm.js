        ...
        <div className="flex">
            ...
            <div className="pb-4 flex flex-wrap gap-x-1 justify-end">
                ...
                <label className="relative md:hidden">
                    <input checked={currentView === "1"} onChange={(e) => handleSort((e.target.id).slice(4))} name="cols" id="cols1" className="peer opacity-0 w-full h-full absolute cursor-pointer" type="radio"/>
                ...
                <label className="relative lg:hidden">
                    <input checked={currentView === "2"} onChange={(e) => handleSort((e.target.id).slice(4))} name="cols" id="cols2" className="peer opacity-0 w-full h-full absolute cursor-pointer" type="radio"/>
                ...
                <label className="relative hidden md:block">
                    <input checked={currentView === "3"} onChange={(e) => handleSort((e.target.id).slice(4))} name="cols" id="cols3" className="peer opacity-0 w-full h-full absolute cursor-pointer" type="radio"/>
                ...
                <label className="relative hidden lg:block">
                    <input checked={currentView === "4"} onChange={(e) => handleSort((e.target.id).slice(4))} name="cols" id="cols4" className="peer opacity-0 w-full h-full absolute cursor-pointer" type="radio"/>
                ...
                <label className="relative hidden xl:block">
                    <input checked={currentView === "5"} onChange={(e) => handleSort((e.target.id).slice(4))} name="cols" id="cols5" className="peer opacity-0 w-full h-full absolute cursor-pointer" type="radio"/>
